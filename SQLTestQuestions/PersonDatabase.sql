...
NOTE: SCRIPT MODIFIED FOR ENTRY TO MYSQL, NOT SQL SERVER
...
CREATE DATABASE IF NOT EXISTS PersonDatabase;
...
INSERT INTO PERSON (PersonID, PersonName, Sex, DateofBirth, Address, IsActive)
...
INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (1, 'Cigna',1.231, 'Bronze',  now() - 3);

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (1, 'Medicare',4.453, 'Gold',  now() - 5);

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (1, 'Cigna', 2.568, 'Silver',  now());

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (1, 'Anthem', 3.945, 'Bronze',  now());

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (2, 'Carefirst',12.51, 'Bronze',  now() - 3);

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (2, 'Carefirst', 50.201, 'Gold',  now());

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (4, 'Cigna', 1.231, 'Bronze',  now());

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (4, 'Anthem', 4.63, 'Silver',  now());

INSERT INTO  Risk (PersonID, AttributedPayer, RiskScore, RiskLevel, RiskDateTime)
VALUES (5, 'Medicare', .342, 'Bronze',  now() - 3);