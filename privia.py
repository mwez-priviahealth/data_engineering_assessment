...
if __name__ == "__main__":
    db_string = "postgresql://postgres:password@localhost:5432/persondatabase"
...
ResultProxy1 = engine.execute(query1)
ResultSetDemo1 = ResultProxy1.fetchall()
dfdemo = pd.DataFrame(ResultSetDemo1)
dfdemo.columns = ResultSetDemo1[0].keys()
...
ResultProxy2 = engine.execute(query2)
ResultSetDemo2 = ResultProxy2.fetchall()
dfqr= pd.DataFrame(ResultSetDemo2)
dfqr.columns = ResultSetDemo2[0].keys()
